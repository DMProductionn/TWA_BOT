...
const Footer = () => {
  ...
  return (
    <div className='w-full px-[15px] mx-auto fixed bottom-0 left-0'>
      {location.pathname === '/' ? null : (
        <footer className="bg-blue-medium h-[75px] mb-[10px] rounded-[20px] flex justify-center items-center z-[999]">
              ...
              <li
                ...
                <svg
                  ...
                  <path
                    ...
                    fill={location.pathname === '/deals' ? '#48D05D' : '#4E5567'}
                  />
                  <path
                    fillRule="evenodd"
                    clipRule="evenodd"
                ...
                <p
                  style={{ color: location.pathname === '/deals' ? '#48D05D' : '#4E5567' }}
                  className="text-[12px]">
                  Сделки
                </p>
              </li>
              <li
                ...
                <svg
                  ...
                  <path
                    ...
                    fill={location.pathname === '/history' ? '#48D05D' : '#4E5567'}
                  />
                  <path
                ...
                <p
                  style={{ color: location.pathname === '/history' ? '#48D05D' : '#4E5567' }}
                  className="text-[12px]">
                  История
                </p>
              </li>
              <li
                ...
                <svg
                  ...
                  <path
                    ...
                    fill={location.pathname === '/profile' ? '#48D05D' : '#4E5567'}
                  />
                  <path
                ...
                <p
                  style={{ color: location.pathname === '/profile' ? '#48D05D' : '#4E5567' }}
                  className='text-[12px]'>
                  Профиль
                </p>
              </li>
