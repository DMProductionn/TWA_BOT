          ...
          <li
            ...
            <svg
              ...
              <path
                ...
                fill={location.pathname === '/' ? '#1FA9FF' : '#fff'}
              />
              <path
                fillRule="evenodd"
                clipRule="evenodd"
            ...
            <p style={{ color: location.pathname === '/' ? '#1FA9FF' : '#fff' }}>Сделки</p>
          </li>
          <li
            className="flex flex-col items-center h-[55px] cursor-pointer"
            ...
            <p style={{ color: location.pathname === '/history' ? '#1FA9FF' : '#fff' }}>История</p>
          </li>
          <li
            className="flex flex-col items-center h-[55px] cursor-pointer"
            ...
            <p style={{ color: location.pathname === '/profile' ? '#1FA9FF' : '#fff' }}>Профиль</p>
          </li>
        </ul>
      </nav>
    </footer>
