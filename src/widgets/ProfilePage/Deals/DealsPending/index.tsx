...
const DealsPending: React.FC = () => {
  const { data } = useGetTransactionsWithStatus('в ожидании');
  ...
  return (
    <>
      {data?.length === 0 ? (
        ...
        data?.map((deal : IDeal) => {
          return (<div key={deal.id} className="bg-blue-dark w-full py-[10px] rounded-[4px] flex justify-between items-center px-[15px] relative">
            ...
            <div className="flex items-center gap-[20px]">
              ...
              <div className="flex flex-col items-center mt-[10px]">
                ...
                <p className="text-[#FFB800] text-[12px] mt-[5px]">В ожидании</p>
              </div>
